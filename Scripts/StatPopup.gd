...
const STATUS_DESCRIPTIONS = {
	...
	"guarded": "Blocks next damage.",
	"unstable": "Takes 1.2x damage from next attack.",
	"poison": "Takes damage each turn.",
	"vulnerable": "Takes increased damage.",
	"chain_reaction_mark": "Next attack triggers a Chain Reaction.",
	"corrosion": "Takes damage each turn (ignores DEF).",
	"invulnerable": "Immune to damage and status.",
	"reactive_vapor": "Takes dmg when attacking.",
	"radiation": "Takes increasing dmg each turn.",
	"refracted": "Accuracy -20%.",
	"insanity": "Accuracy -20%.",
	"static_reflection": "Reflects 30% of incoming damage.",
	"physical_resist": "Resists Physical damage.",
	"mirror_coat": "Reflects next incoming attack.",
	"toxic_feedback": "Reduces attacker's ATK when hit.",
	"radiation_feedback": "Applies Radiation to attackers.",
	"reflective_shell": "Negates hit and reflects 30% damage.",
	"absorb_shield": "Absorbs next hit as Healing.",
	"special_resist": "Resists Special damage.",
	"regeneration": "Restores HP each turn.",
	"reduced": "Primed for Burst.",
	"anodic_barrier": "+DEF and applies [R] to attackers.",
	"processing_loop": "Burst multiplier +0.1 per stack.",
	"halogen_hunger": "Bursts grant +20% Action Gauge.",
	"half_life_cascade": "[R] stacks double each turn.",
	"luminescent": "Next Burst damage +50%.",
	"burn": "Takes burn damage each turn.",
	"proton_charge": "Next attack deals +10% dmg per charge.",
	"spontaneous_fumes": "Auto-triggers Burst on next turn.",
	"excited": "Ignores resistances and defense.",
	"toxic_lattice": "Reflects 2 [R] on hit, reduces dmg taken 30%.",
	"incendiary_flash": "Next Burst is doubled.",
	"entropy_shield": "Blocks Entropy increases.",
	"crimson_resonance": "50% chance to counter-attack.",
	"contrast_shadow": "[R] stacks grant +0.05 Burst multiplier.",
	"radiant_nucleus": "Heals 10% HP/turn, generates 5 Entropy.",
	"bio_poison": "Poison dmg increases each turn.",
	"entropy_dampener": "Reduces next Entropy gain.",
	"radiation_immunity": "Immune to Radiation.",
	"entropy_reflect": "Reflects gained Entropy as damage.",
	"decay_catalyst": "[R] stacks multiply each turn.",
	"entropy_halver": "Halves next Entropy gain.",
	"vanguard_circuit": "Shares Vanguard properties.",
	"entropy_reflect_100": "Reflects 100% Entropy as damage.",
	"irradiated_lock": "[R] stacks locked.",
	"smoke_detector": "Next Burst multiplier +0.5.",
	"synthetic_boost": "Next recoil reduced by 50%.",
	"neutron_trap": "Applies [R] to attackers hitting the shield.",
	"law_of_octets": "Next Burst is doubled.",
	"hidden_potential": "Next Burst multiplier +0.3.",
	"mri_trace": "[R] stacks count as 1.5x.",
	"buff_lock": "Cannot gain positive status.",
